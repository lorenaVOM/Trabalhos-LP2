//1) Reescreva o segundo exercício da Lista 6, usando arquivos do tipo texto e alterando algumas
//  das funções pedidas anteriormente, conforme descrito a seguir:
...
// - IMPRIMIR BOLETIM - além de imprimir na tela, a função deverá escrever os mesmo dados
...
FILE * abrirArquivo (char * nome) { 
	...
	if( (s=fopen(nome,"a+")) == NULL ) { // se o arquivo existe, vou abrir para acréscimo			
